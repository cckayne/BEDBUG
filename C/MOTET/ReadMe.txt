...
I think you'll find that MOTET proves how _easy_ truly strong cryptography is to implement, while avoiding all those NIST/academic chestnuts with their NSA backdoors.


Challenge
---------

You are cordially invited to try breaking the three short MOTET encipherments included in the file Challenge.txt. In the unlikely event you succeed, a cash prize is offered by way of remuneration. Please get in touch at the email address listed below, giving details of your decryption(s). To receive the money, a PayPal account will be required.
...
If you'd like to view cipher-log output during test runs of MOTET, please uncomment "//#define LOG" in cktype.h
